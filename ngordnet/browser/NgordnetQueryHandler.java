...
public abstract class NgordnetQueryHandler implements Route {
    ...
    public abstract Object processQuery(NgordnetQuery query, NGramMap ngm);

    public abstract Object processQuery(Request request, Response response, NGramMap ngm);
